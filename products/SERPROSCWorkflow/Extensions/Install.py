...
from Products.SERPROSCWorkflow.config import PROJECTNAME
from Products.SERPROSCWorkflow.config import product_globals as GLOBALS

def install(self):
    """ External Method to install SERPROSCWorkflow """
    out = StringIO()
    ...
    try:
        from Products.SERPROSCWorkflow.config import DEPENDENCIES
    except:
        DEPENDENCIES = []
    ...
    from Products.SERPROSCWorkflow.config import STYLESHEETS
    try:
        ...
        pass
    from Products.SERPROSCWorkflow.config import JAVASCRIPTS
    try:
