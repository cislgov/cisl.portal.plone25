...
from Products.SERPROSenha.config import PROJECTNAME
from Products.SERPROSenha.config import product_globals as GLOBALS

def install(self, reinstall=False):
    """ External Method to install SERPROSenha """
    out = StringIO()
    ...
    try:
        from Products.SERPROSenha.config import DEPENDENCIES
    except:
        DEPENDENCIES = []
    ...
    # uncatalog tools
    for toolname in ['portal_password']:
        try:
    ...
    portal_controlpanel.unregisterConfiglet('password_tool')
    portal_controlpanel.registerConfiglet(
        'password_tool', #id of your Tool
        'Configurações do portal password', # Title of your Product
        'string:${portal_url}/portal_password/edit',
        ...
        'Configuration for tool password_tool.',
        None,
    )
    ...
    from Products.SERPROSenha.config import STYLESHEETS
    try:
        ...
        pass
    from Products.SERPROSenha.config import JAVASCRIPTS
    try:
