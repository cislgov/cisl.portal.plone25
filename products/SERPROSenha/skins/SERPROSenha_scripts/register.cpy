...
#alterção necessaria para gerar senha do tamnaho minimo que foi definido pelo usuário
password=REQUEST.get('password') or portal_registration.getPassword(length=limpwd)
