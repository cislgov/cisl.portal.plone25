...
class TestInstallation(pstc.PloneSurveyTestCase):
...
class TestContentCreation(pstc.PloneSurveyTestCase):
    ...
    def testSubSurveyAllowedTypes(self):
        ...
        self.failUnless('sm1' in self.s1.objectIds())
        self.s1.invokeFactory('Survey Select Question', 'ssq1')
        self.failUnless('ssq1' in self.s1.objectIds())
