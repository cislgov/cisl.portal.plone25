...
import logging
logger = logging.getLogger('CasosDeSucesso')
...
validation.register(isSpaceValidator('isNotOnlySpace_Casosdesucesso'))
validation.register(isEmailValidator('isValidEmail_Casosdesucesso'))
...
def initialize(context):
    ...
    if CustomizationPolicy and hasattr(CustomizationPolicy, 'register'):
        ...
        print 'Customization policy for CasosDeSucesso installed'
...
profile_registry.registerProfile(
                    'casosdesucesso',
                    'CasosDeSucesso',
                    'Extension profile for CasosDeSucesso Product',
                    'profiles/default',
                    'CasosDeSucesso',
                    EXTENSION,
                    for_=IPloneSiteRoot)
