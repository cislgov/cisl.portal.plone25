...
PROJECTNAME = "SERPROSCMuralProtocoloBSB"
...
STYLESHEETS = [{'id': "serproscmuralprotocolobsb.css", 'media': 'screen', 'rendering': 'import'}]
JAVASCRIPTS = []
...
try:
    from Products.SERPROSCMuralProtocoloBSB.AppConfig import *
except ImportError:
    pass
